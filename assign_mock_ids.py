...
for song in data:
    # randomly select 3 to 5 unique identifiers for each song
    song["shows"] = random.sample(identifiers, k=random.randint(3, 5))
...
print("Succesfully assigned random verified Archive.org identifiers.")
